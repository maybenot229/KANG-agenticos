...
| [036](036-async-migration-slice-plan.md) | The async migration slice plan: a bounded write-executor + read-pool inside `adapters/sqlite/`, not a rewrite of the 18 stores/15 handlers | accepted — D2/D3/D4-plumbing DONE, D4 read-pool routing still deferred | `api/http_binding.py`, `kernel/runtime/{composition,scheduler_wiring}.py`, `adapters/sqlite/connection_pool.py` |
