...
| [036](036-async-migration-slice-plan.md) | The async migration slice plan: a bounded write-executor + read-pool inside `adapters/sqlite/`, not a rewrite of the 18 stores/15 handlers | accepted (sequencing/destination only) | none yet — sequences ADR-030/035's delivery; each slice's own PR is reviewed against it |
