...
| [028](028-m7-foundations.md) | M7 foundations: the four constraints the code imposes, the `task` collision, and the one fork that needs Kang | accepted (O1 open, pending ADR-030) | none yet (constraints + sequencing; each slice gets its own ADR) |
