...
| [010](010-pydantic-schema-implementation.md) | Pydantic schema implementation: layout, attachment, null-schema contract, validation-error mapping | proposed | 12_API §2/§16, 17_PROJECT_STRUCTURE (`api/schemas/`), `src/kang/api/registry/__init__.py`, `src/kang/api/dispatch.py` |
