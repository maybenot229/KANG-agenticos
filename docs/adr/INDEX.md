...
| [035](035-operation-channel-transport-after-async.md) | The operation channel's transport after ADR-030: `http.server` does not survive — recommends `aiohttp` | **proposed** | 04_ARCH D002, 11_CODING §12, 17_PROJECT_STRUCTURE §4.1 (`api/` legality matrix), amends ADR-009 Part A |
