"""The operation registry literal — every `_op(...)` entry (12_API §16).
...
the event-type and error-code passthrough, and re-exports `OPERATIONS`
from here so every external caller's import path is unchanged.
"""
