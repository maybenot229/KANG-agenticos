...
same tracking-only scope, per project. Goals and any project/milestone
status-transition remain unbuilt; see each module's own docstring for
its exact scope line.
"""
