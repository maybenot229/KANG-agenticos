...
core; when the asyncio runtime (D015) lands, an AsyncSleeper joins behind
the same port. This is not a wall-clock READ (the banned pattern) — it is a
bounded delay, the port's whole purpose.
"""
